...
.btn-login{padding:6px 18px;background:var(--accent);color:var(--gold);font-size:11px;letter-spacing:1px;cursor:pointer;border:1px solid var(--gold);font-family:inherit;transition:all var(--tr)}.btn-login:hover{background:var(--gold);color:var(--tx)}
...
.nav-avatar{width:28px;height:28px;background:var(--t);color:var(--ts);display:flex;align-items:center;justify-content:center;font-size:12px;font-weight:500;transition:all var(--tr);border:1px solid var(--gold)}.nav-user:hover .nav-avatar{background:var(--accent);color:var(--gold)}
